...
oneJQuery(function ($) {
    ...
    json.afterAction = function () {
        ...
        oneJQuery('#slidesjs-24D4E043-9226-407A-9038-64C53CFBA3B7 .slider-caption').each(function () {
            var el = oneJQuery(this);
            el.width(el.parent().width() - 10);
        });
        oneJQuery('#slidesjs-24D4E043-9226-407A-9038-64C53CFBA3B7 .slide-cntnr.middle p.slider-caption').each(function () {
            var el = oneJQuery(this);
            el.height(el.find('span').height());
        });
    };
    var $slidejs = $('#slidesjs-24D4E043-9226-407A-9038-64C53CFBA3B7');
    if ($slidejs.children().length) {
        ...
        var resetHeight = function () {
            if (window.innerWidth < 650) {
                var ratio = 0.2;
                if ($('#slidesjs-24D4E043-9226-407A-9038-64C53CFBA3B7').parents('.textblock').length) {
                    ratio = ratio / 2;
                }
                $('#slidesjs-24D4E043-9226-407A-9038-64C53CFBA3B7').height((window.innerWidth - 40) * ratio);
                $('#slidesjs-24D4E043-9226-407A-9038-64C53CFBA3B7 .slider-item').height((window.innerWidth - 40) * ratio);
                $('#slidesjs-24D4E043-9226-407A-9038-64C53CFBA3B7 .slider-caption').parent().height((window.innerWidth - 40) * ratio);
            }
        };
